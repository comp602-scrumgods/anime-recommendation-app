...
import { getWatchlist, removeFromWatchlist, updateStatus } from "../utils/watchlist";
          ...
          sectionData.map((anime, index) => (
            <View key={index} style={styles.animeRow}>
              ...
              <View style={styles.buttonRow}>
                ...
                <TouchableOpacity onPress={() => handleChangeStatus(anime.id, "watching")}>
                  <Text style={styles.statusButton}>Watching</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => handleChangeStatus(anime.id, "watched")}>
                  <Text style={styles.statusButton}>Watched</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => handleChangeStatus(anime.id, "wantToWatch")}>
